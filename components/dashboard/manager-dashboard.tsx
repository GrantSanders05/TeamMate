...
export function ManagerDashboard() {
  ...
  const publishedPeriods = useMemo(
    () => periods.filter((period) => period.status === "published"),
    [periods]
  )
  ...
  if (!organization) {
    return (
      <PageShell title="Dashboard" subtitle="Manage your organization from one place.">
        <SectionCard>
  ...
  return (
    <PageShell
      title="Dashboard"
      subtitle="A polished command center for periods, people, and schedule follow-up."
    >
      <div className="space-y-6">
          ...
          <div className="overflow-hidden rounded-[32px] border border-slate-900/10 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-700 p-6 text-white shadow-xl">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              <div className="rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-white">
                {activePeriods.length} active period{activePeriods.length === 1 ? "" : "s"}
              </div>
            ...
            <div className="mt-6 grid gap-3 md:grid-cols-2">
              ...
              <Button
                asChild
                variant="outline"
                className="h-12 rounded-2xl border-white/25 bg-white/10 text-white hover:bg-white/15 hover:text-white"
              >
            ...
            <div className="mt-5 space-y-3">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-lg font-semibold text-slate-900">Schedules</p>
                    <p className="text-sm text-slate-600">Build periods, shifts, and assignments</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Review archived schedule periods</p>
                  </div>
                </div>
                <ArrowRight className="h-5 w-5 text-slate-400 transition group-hover:text-slate-700" />
              </Link>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Adjust branding, templates, and org tools</p>
                  </div>
                </div>
                <ArrowRight className="h-5 w-5 text-slate-400 transition group-hover:text-slate-700" />
              </Link>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <SectionCard>
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Active Periods</p>
                <p className="mt-3 text-4xl font-semibold text-slate-900">{activePeriods.length}</p>
                <p className="mt-2 text-sm text-slate-600">Current periods across draft, collecting, scheduling, and published.</p>
              </div>
          ...
          <SectionCard>
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Pending Drops</p>
                <p className="mt-3 text-4xl font-semibold text-slate-900">{pendingDrops}</p>
                <p className="mt-2 text-sm text-slate-600">Employee drop requests waiting on manager review.</p>
              </div>
          ...
          <SectionCard>
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Team Size</p>
                <p className="mt-3 text-4xl font-semibold text-slate-900">{employeeCount}</p>
                <p className="mt-2 text-sm text-slate-600">Active employees currently attached to this organization.</p>
              </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
          <SectionCard
            ...
            description="Keep tabs on your most recent periods without jumping into the full schedules page."
          >
            {periods.length === 0 ? (
              ...
              <div className="space-y-3">
                {periods.slice(0, 5).map((period) => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <div className={`inline-flex rounded-full border px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] ${meta.pill}`}>
                          {meta.label}
                        </div>
                        <h3 className="mt-3 text-xl font-semibold text-slate-900">{period.name}</h3>
          ...
          <SectionCard
            title="Manager attention board"
            description="A fast visual summary of what likely needs action first."
          >
            <div className="space-y-3">
              <div className="rounded-[24px] border border-amber-200 bg-amber-50 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-base font-semibold text-amber-950">Pending drop requests</p>
              ...
              <div className="rounded-[24px] border border-blue-200 bg-blue-50 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-base font-semibold text-blue-950">Availability collection</p>
                    <p className="mt-1 text-sm text-blue-900">
                      {collectingPeriods.length === 0
                        ? "No periods are currently collecting availability."
                        : `${collectingPeriods.length} period${collectingPeriods.length === 1 ? "" : "s"} are still collecting availability.`}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-[24px] border border-emerald-200 bg-emerald-50 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-base font-semibold text-emerald-950">Published schedules</p>
                    <p className="mt-1 text-sm text-emerald-900">
                      {publishedPeriods.length === 0
                        ? "No schedule periods are currently published."
              ...
              <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-base font-semibold text-slate-900">Archive count</p>
                    <p className="mt-1 text-sm text-slate-600">
                      {archivedPeriods.length} archived period{archivedPeriods.length === 1 ? "" : "s"} saved in history.
                    </p>
                  </div>
                </div>
              </div>
